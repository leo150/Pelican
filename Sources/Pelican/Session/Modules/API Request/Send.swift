...
public class TGSend {
	...
	*/
	@discardableResult 
	public func message(_ message: String, markup: MarkupType? = nil, parseMode: MessageParseMode = .markdown, replyID: Int = 0, webPreview: Bool = false, disableNtf: Bool = false) -> Message {
	...
	*/
	public func file(_ file: MessageFile, caption: String, markup: MarkupType? = nil, replyID: Int = 0, disableNtf: Bool = false, callback: ReceiveUpload? = nil) {
